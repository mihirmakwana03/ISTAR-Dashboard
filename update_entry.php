				...
				<div class="col-lg-12">
					...
					<div class="card">
						<div class="card-body">
							...
							<!-- Horizontal Form -->
							<form name="update_entry" action="update_entry.php" method="post">
											...
											<?php
												...
												if ($result->num_rows > 0) {
													while ($row = $result->fetch_assoc()) {
														echo '<option selected value="' . $row['managed_by'] . '">' . $row["managed_by"] . '</option>';
													}
												} else {
													echo "No data found";
												}
								...
								<div class="row mb-3">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" name="clg_out_no">
									</div>
								</div>
								...
								<div class="row mb-3">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" name="clg_in_no">
									</div>
								</div>
					...
					<input type="password" class="form-control" id="inputPassword">
								...
								<div class="row mb-3">
									<label for="inputtextarea"
										class="col-sm-2 col-form-label">Description/Details</label>
									<div class="col-sm-10">
								...
								<div class="row mb-3">
									...
									<div class="col-sm-10">
										<input type="date" class="form-control" id="inputText" name="appr_date">
									</div>
								</div>
								...
								<div class="row mb-3">
									...
									<div class="col-sm-10">
										<input type="number" class="form-control" name="appr_amt">
									</div>
								</div>
								...
								<div class="row mb-3">
									...
									<div class="col-sm-10">
										<input type="date" class="form-control" id="inputText" name="bill_appr_date">
									</div>
								</div>
								...
								<div class="row mb-3">
									...
									<div class="col-sm-10">
										<input type="number" class="form-control" name="bill_amt">
								...
								<tbody id="data">
									...
									if ($result->num_rows > 0) {
										while ($row = $result->fetch_assoc()) {
											...
											echo "<a href='update_entry.php' class='btn btn-info'><i class='bi bi-pencil-square'></i></a>";
											echo "<a href='delete_entry.php' class='btn btn-danger'><i class='bi bi-trash'></i></a>";
											echo "</td>";
											echo "</tr>";
										}
									} else {
