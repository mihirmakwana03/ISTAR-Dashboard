...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$sql = "INSERT INTO admin (username, password, email, security_question, security_answer) VALUES (?, ?, ?, ?, ?)";
						...
						<div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
							...
							<div class="d-flex justify-content-center py-4">
								<a href="index.php" class="logo d-flex align-items-center w-auto">
									...
									<span class="d-none d-lg-block">Admin Register</span>
								</a>
							</div><!-- End Logo -->
							...
							<div class="card mb-3">
								...
								<div class="card-body">
									...
									<form name="register" method="post" action="admin-register.php" class="row g-3 needs-validation" novalidate>
										<div class="col-12">
