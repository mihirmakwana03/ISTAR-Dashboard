...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="agency.php" class="active">Agency's</a></li>
        </ol>
      </nav>
    </div>
          ...
          <div class="row">
            ...
            <div class="col-xxl-3 col-md-6">
              <div id="date" class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Connected Agency's</h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      ...
                      <span class="text-success small pt-1 fw-bold" style="font-size: 120%;">Total Agency</span>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "INSERT INTO agencies (agency_name) VALUES ('$name')";
            ...
            <tbody id="data">
              ...
              if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                  $delete = "delete_agency.php?id=" . $row["agency_id"];
                  echo "<tr>
                                        <td width='2%'>" . $row["agency_id"] . "</td>
                                        <td width='20%'>" . $row["agency_name"] . "</td>
                                        ...
                                        <td width='5%'>
                                            ...
                                            <a href='#' class='btn btn-outline-success' role='button' style='height: 30px;font-size: 12px;'>EXCEL/CSV</a>
