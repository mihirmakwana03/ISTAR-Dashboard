            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              <div class="d-flex justify-content-center py-4">
                <a href="index.php" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">ISTAR Login</span>
                </a>
              </div><!-- End Logo -->
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <form name="login" method="GET" action="pages-login.php" class="row g-3 needs-validation" novalidate>
                    <div class="col-12">
                    ...
                    <div class="col-12" align="center">
                      <p class="small mb-0">Don't have account? <a href="pages-register.php">Create an account</a></p><br>
                    </div>
                  </form>
              ...
              <div class="credits align-items-center justify-content-center" align="center">
                Designed & Developed by <a href="#">Yogesh Rana</a> & <a href="#"> Mihir Makwana </a></h6>
              </div>
            </div>
          </div>
      </section>
