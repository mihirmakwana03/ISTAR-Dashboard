...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>CVM University (School/College/Institute's) </h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          <li class="breadcrumb-item">Data</li>
          <li class="breadcrumb-item"><a href="cvmu.php" class="active">CVM University</a></li>
        </ol>
      </nav>
    </div>
    ...
    <section class="section dashboard">
      ...
      $sql = "SELECT * FROM institutes where organization_id=2";
      $result = $conn->query($sql);
      $records = $result->num_rows;

      ?>
      <!-- <div>Total Institutes under CVMU: <?php echo $records; ?></div> -->
      <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-xxl-3 col-md-6">
              <div id="date" class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Institute's Under CVMU</h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      ...
                      <span id="dateDisplay" class="text-success small pt-2 ps-1 fw-bold"
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- Horizontal Form -->
              <form action="cvmu.php" method="post">
                <div class="row mb-3">
                  <label for="inputtext" class="col-sm-2 col-form-label">Enter the Name </label>
                  <div class="col-sm-10">
                    <input type="text" required class="form-control" id="inputText" name="name" required>
                  </div>
                </div>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "INSERT INTO institutes (name, organization_id, organization_name) VALUES ('$name', 2, 'CVMU')";
            ...
            <tbody id="data">
              ...
              if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                  $delete = "delete_cvmu.php?id=" . $row["id"];
                  echo "<tr>
